...
export interface ArrayBlock {
  ...
  dynamic?: boolean; // if true, managers can add/remove rows with + / Ã¢Ë†â€™
...
export const SECTIONS: Section[] = [
  {
    ...
    fields: [
      ...
      g(N("front.child_5_12", "Children 5-â€œ12"), "Accommodation"),
      ...
      g(N("front.ta_pos", "TA positive (4-â€œ5)"), "Feedback"),
      g(N("front.ta_poor", "TA poor (1-â€œ3)"), "Feedback"),
      g({ path: "front.google_rating", label: "Google rating", type: "rating" }, "Feedback"),
      g(N("front.google_pos", "Google positive (4-â€œ5)"), "Feedback"),
      g(N("front.google_poor", "Google poor (1-â€œ3)"), "Feedback"),
    ],
    arrays: [
      {
        path: "travel_agents",
    ...
    arrays: [
      {
        ...
        columns: [
          ...
          { key: "cost", label: "Cost Ã¢â€šÂ¹", type: "number" },
  ...
  {
    key: "denwa_safari",
    title: "Section 10 â€” Safari & activities (Denwa)",
  ...
  },
  {
    ...
    title: "Section 10b â€” Naturalist assignments (Denwa)",
    lodges: ["Denwa Backwater Escape"],
    arrays: [
      {
  ...
  {
    key: "denwa_delhi",
    title: "Section 11 â€” For Delhi Team (Denwa)",
    lodges: ["Denwa Backwater Escape"],
    arrays: [
      {
        path: "denwa_delhi",
